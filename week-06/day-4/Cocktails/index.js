...
app.get('/', (req, res) => {
  let newCocktails=filterCocktails(cocktails,req.query.alcohol)
  console.log(typeof req.query.alcohol)
  res.render('home', {
...
app.listen(PORT, () => {
  ...
  console.log(filterCocktails(cocktails,'gin'))
});


function filterCocktails(alcoholList,alcohol){
  if (alcohol === undefined || alcohol==='all'){
    console.log(alcohol)
    return alcoholList
  }else{
    return alcoholList.filter(function(e){
